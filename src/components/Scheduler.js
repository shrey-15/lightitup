...
export const Scheduler = () => {
  ...
  return (
    <div className="lg:container md:mx-auto mt-8 z-0">
      ...
      <div className="flex grid grid-flow-col grid-cols-5 gap-4 items-center m-8 mx-10 bg-gray-200 rounded-md">
        <div className="flex col-span-12 items-center justify-start mr-14 p-4 bg-gray-200 rounded-md">
          <Typography className="text-lg sm:text-sm text-primary font-bold">
            For Non-Peak Hours:
          </Typography>
        </div>
      ...
      <div className="flex grid grid-flow-col grid-cols-12 gap-4 items-center m-8 mx-10 rounded-md">
        <div className="flex col-start-1 col-span-2 items-center justify-center rounded-md">
          <TimeSelecter />
        </div>
        ...
        <div className="flex col-start-9 col-span-1 items-center justify-center rounded-md">
          <Button
            onClick={() => {
              setCount(count + 1);
            }}
